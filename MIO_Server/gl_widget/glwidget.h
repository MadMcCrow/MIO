...
private:
    ...
    QOpenGLVertexArrayObject m_vao; ///<@brief the VAO. we don't use it (but we could)
    QOpenGLBuffer m_vbo;            ///<@brief the VBO. we use it to store the vertex data
    QOpenGLBuffer m_vbo2;            ///<@brief the VBO. we use it to store the vertex data

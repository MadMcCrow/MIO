...
#include "../MIO_Server/log_widget/logwidget.h"
...
QT_MOC_LITERAL(5, 34, 12) // "writeInLog_c"

    },
    "LogWidget\0toLog_s\0\0texte\0priority\0"
    "writeInLog_c"
};
...
void LogWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->writeInLog_c((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (LogWidget::*_t)(QString , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&LogWidget::toLog_s)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LogWidget::toLog_s(QString _t1, int _t2)
{

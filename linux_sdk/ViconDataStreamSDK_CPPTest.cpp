...
#include <iostream>
#include <cstring> //ICI Rajout de ma part pour que 'atoi' marche
#include <cstdlib> //ICI Rajout de ma part pour que 'atoi' marche
#include <fstream>
#include <cassert>
#include <ctime>
#include <vector>
...
int main( int argc, char* argv[] )
{
  ...
  for(int a=2; a < argc; ++a)
  {
    ...
    else if( arg == "--client-buffer-size" )
    {
      ...
      if( a < argc )
      {
        ClientBufferSize = atoi( argv[a] ); //C'est quoi??
      }
    }
    else
    {
